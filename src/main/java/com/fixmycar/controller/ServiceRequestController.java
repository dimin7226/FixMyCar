...
public class ServiceRequestController {
    ...
    @ApiResponse(responseCode = "200", description = "Заявка успешно создана")
    @ApiResponse(responseCode = "400", description = "Некорректные данные")
    public ResponseEntity<ServiceRequest> createFullRequest(@Valid @RequestBody ServiceRequest request) {
        if (request.getCustomer() == null || request.getCar() == null || request.getServiceCenter() == null) {
            throw new ValidationException("Customer, car, and service center are required");
        }
